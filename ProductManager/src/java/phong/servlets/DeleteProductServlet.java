...
public class DeleteProductServlet extends HttpServlet {
    ...
    private final String deleteErrPage = "warning.html";
        ...
        try {
            ...
            if (session != null) {
                ...
                if (result) {
                    ...
                    request.setAttribute("MSG", "Delete Succes!!!");
                    url = productPage;
                }
            }else {
                url = loginPage;
            ...
            log("SQLException-Delete: " + ex.getMessage());

        } catch (NamingException ex) {
            log("NamingException-Delete: " + ex.getMessage());
        } finally {
